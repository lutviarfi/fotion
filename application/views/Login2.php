...
<link href="<?php blink('assets/global/plugins/font-awesome/css/font-awesome.min.css')?>" rel="stylesheet" type="text/css"/>
...
<link href="<?php blink('assets/admin/pages/css/login.css')?>" rel="stylesheet" type="text/css"/>
...
<link href="<?php blink('assets/admin/layout/css/layout.css')?>" rel="stylesheet" type="text/css"/>
<link href="<?php blink('assets/admin/layout/css/themes/default.css')?>" rel="stylesheet" type="text/css" id="style_color"/>
<link href="<?php blink('assets/admin/layout/css/custom.css')?>" rel="stylesheet" type="text/css"/>
<!-- END THEME STYLES -->
...
<div class="content">
	<!-- BEGIN LOGIN FORM -->
	<form class="login-form" action="<?php blink('login/auth')?>" method="post">
		...
		<div class="create-account">
			<p>
				...
				<!-- <a href="<?php blink('login/input') ?>" id="register-btn" class="uppercase">Create an account</a> -->
	...
	<!-- <form class="register-form" action="index.html" method="post"> -->
		<p class="hint"> 
			<form action="<?php blink('Login/InsertDaftar')?>" method="post" class="register-form">
		<h3>Sign Up</h3>
		<p class="hint">
		...
		<div class="form-group">
			<label class="control-label visible-ie8 visible-ie9">Auth</label>
			<select name="auth">
...
<script src="<?php blink('assets/global/plugins/jquery-validation/js/jquery.validate.min.js')?>" type="text/javascript"></script>
<!-- END PAGE LEVEL PLUGINS -->
<!-- BEGIN PAGE LEVEL SCRIPTS -->
<script src="<?php blink('assets/global/scripts/metronic.js')?>" type="text/javascript"></script>
<script src="<?php blink('assets/admin/layout/scripts/layout.js')?>" type="text/javascript"></script>
<script src="<?php blink('assets/admin/layout/scripts/demo.js')?>" type="text/javascript"></script>
<script src="<?php blink('assets/admin/pages/scripts/login.js')?>" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<script>
