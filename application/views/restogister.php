...
<!-- BEGIN THEME STYLES -->
	...
	<!-- Custom Theme files -->
	<link href="<?php blink('restogister/css/font-awesome.css')?>" rel="stylesheet">
	<link href="<?php blink('restogister/css/style.css')?>" rel="stylesheet" type="text/css" />
	<!--fonts-->
...
<body>
	...
	<p class="footer-agile">FOTION © 2018</a>
	</p>
