	...
	<div class="container">
		...
		<div class="nav-icon">
          ...
          <ul class="toggle-menu">
						...
						<li><a class="active" href="<?php echo('PickerRegister')?>">Login Here</a></li>
					</ul
          <li>
	...
	<div class="container">
      ...
      <div class="portlet light">
        ...
        <div class="portlet-body form">
          <form role="form" action="<?php blink('RestoranLoginController/auth')?>" enctype="multipart/form-data" method="post" class="form-horizontal">
            <div class="form-body">
              <div class="form-group form-md-line-input">
                <label class="col-md-2 control-label" for="form_control_1">Username</label>
                <div class="col-md-10">
                  <input type="text" class="form-control" name="username" id="email" placeholder="Enter your username">
