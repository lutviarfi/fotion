							...
							<div class="tab-pane active" id="tab_0">
								<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-gift"></i>REGISTRATION PICKER
										</div>
										<div class="tools">
										...
										<form action="<?php blink('regispicker/InsertPicker')?>" method="post" class="form-horizontal">
											<div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control input-circle" placeholder="Nama" id="nama" name="nama">
													</div>
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													...
													<div class="col-md-4">
															<input type="text" class="form-control input-circle" name="lokasi" id="lokasi" placeholder="Lokasi">
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-md-4">
															<input type="text" class="form-control input-circle" name="kondisi" id="kondisi" placeholder="Kondisi">
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-md-4">
															<input type="password" class="form-control input-circle" name="passowrd" id="passowrd" placeholder="Password">
													</div>
												</div>
