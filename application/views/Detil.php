	...
	<div class="page-head">
		<div class="container">
			...
			<div class="page-title">
				<h1>Detil<small>&nbsp Buku</small></h1>
			</div>
			<!-- END PAGE TITLE -->
			<!-- BEGIN PAGE TOOLBAR -->
							...
							<div class="tab-pane active" id="tab_0">
								<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-gift"></i>Detil Buku Perpustakaan
										</div>
										<div class="tools">
										...
										<!-- BEGIN FORM-->
											<div class="form-body">
												...
												<?php foreach($buku as $data){?>
												 	...
												 	<tr><td>Judul Buku  </td><td><?php echo $data->judul;?></td></tr>
													<tr><td>Penulis  </td><td><?php echo $data->penulis;?></td></tr>
													<tr><td>Penerbit  </td><td><?php echo $data->penerbit;?></td></tr>
                                                    <tr><td>Tanggal Terbit  </td><td><?php echo $data->tglterbit;?></td></tr>
													<tr><td>Sinopsis Buku  </td><td><?php echo $data->sinopsis;?></td></tr>
											...
											<div class="form-actions">
												<div class="row">
													...
													<a href="<?php blink('CRUD') ?>" type="button" class="btn btn-circle default">Kembali</a>
