	...
	<div class="container">
      ...
      <div class="portlet light">
        ...
        <div class="portlet-body form">
          ...
          <form role="form" action="<?php blink('RestoranRegistController/InsertData')?>" method="post" class="form-horizontal">
            <div class="form-body">
            ...
            <div class="form-actions">
              <div class="row">
                <div class="col-md-offset-2 col-md-10">
                  <button type="submit" name="simpan" class="btn blue">Register</button>
